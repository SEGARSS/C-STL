...
int main()
{
	...
	//Сейчас элементво в векторе = 8.
	vector<int> myVector2 = {2, 74, 9, 367};
	myVector2.push_back(35);
	myVector2.push_back(36);
	myVector2.push_back(64);
	myVector2.push_back(985);


	cout << "Посмотрим разницу между методом myVector2.size() и myVector2.capasity()" << endl;

	cout << "Смотрим количество элементов в векторе вызывая метод myVector2.size(): " << myVector2.size() << endl;
	cout << "Смотрим количество элементов в векторе вызывая метод myVector2.capacity(): " << myVector2.capacity() << endl;
	...
	*/
	...
	тоесть shrink_to_fit выполняет функцию контроля, чтоб не постоянно держать резерв открытым в 100000 ячеек, а открывать
	их тогда, когда по требуется.
	Просто держать постоянно в пустую резер памяти под 100000 ячеек не целесообразно и трата в пустую памяти.
	*/
	...
	cout << "Смотрим количество элементов в векторе вызывая метод myVector3.size(): " << myVector3.size() << endl;
	cout << "Смотрим количество элементов в векторе вызывая метод myVector3.capacity(): " << myVector3.capacity() << endl;
	...
	cout << "Смотрим количество элементов в векторе вызывая метод myVector4.size(): " << myVector4.size() << endl;
	cout << "Смотрим количество элементов в векторе вызывая метод myVector4.capacity(): " << myVector4.capacity() << endl;
